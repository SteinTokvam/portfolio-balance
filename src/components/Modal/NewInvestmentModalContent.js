import { Input, Select, SelectItem, Button, ModalContent, ModalHeader, ModalBody, ModalFooter, Textarea } from '@nextui-org/react';
...
export default function NewInvestmentModalContent({ setScreen = () => { }, isEdit }) {
